# /Privacy Policy
Liftez App only uses user info for the purpose and sending/sharing logging entries or regimens via email that are created within the app in HTML email format with a PDF attachment of that email content. We do not collect or store personal data for any other purpose at this time.
